...
```bash
$ # cd into raspilot directory. It must be located inside of raspilot so that it can access
neccessary files
$ cd ~/raspilot
$ # Get the code and save it as web-UI
$ git clone https://github.com/two70/flask-dashboard-adminlte.git web-UI
$ cd web-UI
$
